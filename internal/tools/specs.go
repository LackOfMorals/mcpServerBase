// specs.go — MCP tool specifications for the four meta-tools.
...
Possible status values:
  ...
  completed – finished successfully; poll returns the tool output directly
  failed    – handler returned an error; the error field describes the failure`),
