// registry.go — ToolRegistry manages ToolDef registrations and dispatches execution.
...
// background execution. Returns the job ID, or a Go error if the tool cannot run.
